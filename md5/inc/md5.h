...
void						md5_init(uint8_t *input, size_t input_len);
void						md5_transform(t_contxt *context, uint32_t *chunk);
void						md5_sets(t_contxt *context, int o);
void						md5_chunking(uint8_t *input, int padded_length,
		t_contxt *context);
void						md5_decode(t_contxt *context);
uint32_t					md5_crunch(t_contxt *context, int i);
void						md5_final(t_contxt *context, uint8_t *input,
		int padded_length);
